...
{
    public partial class menuBalki : Form
    {
        public menuBalki()
        {
            InitializeComponent();
        ...
        private void menuBalki_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Connection = con;
                cmd.CommandText = "SELECT ID, Warehouse_location, Stock_count FROM Stock WHERE Timber_type='Baļķi'";
                ...
                while (reader.Read())
                {
                    ...
                    lvwBalkiList.Items.Add(itemRow);
                }
                con.Close();
            }
            catch (Exception ex)
