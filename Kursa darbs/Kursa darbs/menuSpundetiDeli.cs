...
{
    public partial class menuSpundetiDeli : Form
    {
        public menuSpundetiDeli()
        {
            InitializeComponent();
        }
        ...
        private void menuBalki_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Connection = con;
                cmd.CommandText = "SELECT ID, Warehouse_location, Stock_count FROM Stock WHERE Timber_type='Spundēti dēļi'";
                ...
                while (reader.Read())
                {
                    ...
                    lvwSpundetiDeliList.Items.Add(itemRow);
                }
                con.Close();
            }
            catch (Exception ex)
