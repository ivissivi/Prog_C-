...
{
    public partial class menuBrusas : Form
    {
        public menuBrusas()
        {
            InitializeComponent();
        ...
        private void menuBalki_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Connection = con;
                cmd.CommandText = "SELECT ID, Warehouse_location, Stock_count FROM Stock WHERE Timber_type='Brusas'";
                ...
                while (reader.Read())
                {
                    ...
                    lvwBrusasList.Items.Add(itemRow);
                }
                con.Close();
            }
            catch (Exception ex)
