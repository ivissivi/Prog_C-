...
{
    public partial class menuCLT : Form
    {
        public menuCLT()
        {
            InitializeComponent();
        ...
        private void menuBalki_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Connection = con;
                cmd.CommandText = "SELECT ID, Warehouse_location, Stock_count FROM Stock WHERE Timber_type='CLT-paneļi'";
